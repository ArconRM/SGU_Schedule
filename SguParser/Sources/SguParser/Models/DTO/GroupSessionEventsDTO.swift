...
public struct GroupSessionEventsDTO: Equatable {

    public var group: AcademicGroupDTO
    public var sessionEvents: [SessionEventDTO]

    public init(groupNumber: String, departmentCode: String, sessionEvents: [SessionEventDTO]) {
    ...
    public func getNextConsultationAndExam() -> (consultation: SessionEventDTO?, exam: SessionEventDTO?) {
