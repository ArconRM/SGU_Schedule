...
public struct GroupScheduleDTO: Equatable {

    public var group: AcademicGroupDTO
    public var lessons: [LessonDTO]
    public var lastUpdated: String

    public init(groupNumber: String, departmentCode: String, lessonsByDays: [LessonDTO], lastUpdated: String) {
    ...
    public var lessonsAndWindows: [any ScheduleEvent] {
    ...
    public func getFirstLessonByDay(subgroupsByLessons: [String: [LessonSubgroupDTO]], weekDayNumber: Int) -> LessonDTO? {
    ...
    public func getTodayFirstLesson(subgroupsByLessons: [String: [LessonSubgroupDTO]]) -> LessonDTO? {
    ...
    public func getCurrentAndNextLessons(subgroupsByLessons: [String: [LessonSubgroupDTO]]) -> (
    ...
    public func getSubgroupsByLessons(savedSubgroups: [String: LessonSubgroupDTO]) -> [String: [LessonSubgroupDTO]] {
